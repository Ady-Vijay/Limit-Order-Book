...
uint64_t OrderBook::best_price(Order& order, std::map<uint64_t, std::list<Order>>& order_type){
...
void OrderBook::fulfilment(Order& order, std::map<uint64_t, std::list<Order>>& order_type){
...
uint64_t OrderBook::match(Order&& incoming_order){
